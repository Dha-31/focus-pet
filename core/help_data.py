...
FEATURES = [
    ...
    {"id": "skin", "name": "更换形象 / 自定义桌宠",
     ...
     "what": "用自己的图片当桌宠，自动适配所有状态/装饰/托盘图标；或导入多状态主题包 zip。建议用白底/浅色背景的照片，AI 抠图更干净",
     "added_in": "3.0"},
    {"id": "shop", "name": "商店",
     "where": "右键桌宠 →「商店…」",
     "what": "用专注币买装饰品和家具（专注 1 分钟 = 1 币）",
     "added_in": "3.1"},
    {"id": "space", "name": "我的空间",
     "where": "右键桌宠 →「我的空间…」",
     "what": "宠物的房间，摆放买到的家具",
    ...
    {"id": "pet_headpat", "name": "摸头",
     "where": "单击桌宠本体（不是拖动）",
     "what": "摸头 +1 好感（3 秒冷却），宠物会开心回应",
     "added_in": "4.0.1"},
    {"id": "feed", "name": "投喂",
     "where": "右键桌宠 →「投喂…」",
     "what": "花专注币买食物喂宠物，增加好感（小鱼干/牛奶/蛋糕，价格与好感在设置里可调）",
     "added_in": "4.0.1"},
    {"id": "work", "name": "打工（工作时钟）",
     "where": "右键桌宠 →「打工…」",
     "what": "让宠物去上班赚专注币：选时长开始倒计时（头顶显示 💼），时间到自动结算；中途取消无奖励；汇率和时长在设置里可调",
     "added_in": "4.0.1"},
    {"id": "checkin", "name": "每日打卡",
     "where": "右键桌宠 →「每日打卡…」；启动时未打卡会提醒",
     "what": "每天限一次领专注币，连续打卡额外奖励（连续第 N 天 +N×加成）",
     "added_in": "4.0.1"},
    {"id": "mini_game", "name": "小游戏（猫猫接金币）",
     "where": "右键桌宠 →「小游戏…」",
     "what": "←→/AD 移动接金币、躲炸弹，60 秒结算兑换专注币（每天有上限防刷）；休息时玩最合适",
     "added_in": "4.0.1"},
