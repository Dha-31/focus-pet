...
FAQ = [
    ...
    ("上传自己的照片有什么讲究吗？",
     "① 最好用白底/浅色背景的照片，AI 抠图后边缘更干净（深色/复杂背景容易抠不干净）；"
     "② 人物或主体尽量完整、清晰、别太小；③ 第一次抠图会联网下载 AI 模型，稍等片刻。"),
    ("为什么更新客户端后我的自定义皮肤没了？",
     "v3.7.1 起皮肤/配置/日志都保存在稳定位置（%LOCALAPPDATA%\\FocusPet），"
     "更新客户端不会丢；更早版本导入的皮肤如果丢了，重新导入一次即可。"),
    ("用了自己的图片当桌宠，会不会不兼容？",
