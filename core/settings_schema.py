...
DEFAULTS = {
    "economy": {
        "coin_per_minute": 0.2,      # 每专注 1 分钟获得的金币数（0.1 = 10 分钟 1 币）
        "achievement_reward": 30,    # 每解锁一个成就奖励的金币
    ...
    "checkin": {
        "base_reward": 20,      # 每日打卡基础奖励金币
        "streak_bonus": 4,      # 连续签到额外加成（连续第 N 天 +N*2 币）
    },
    "feed": {
        "items": [
...
SETTINGS_SCHEMA = [
    ...
    # 商店价格（按地图分组）
    # -- 温馨小屋 --
    {"path": "shop.prices.rug", "file": "settings", "category": "商店", "label": "软软地毯价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.lamp", "file": "settings", "category": "商店", "label": "小台灯价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.plant", "file": "settings", "category": "商店", "label": "绿植价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.clock", "file": "settings", "category": "商店", "label": "挂钟价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.window", "file": "settings", "category": "商店", "label": "大窗户价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.table", "file": "settings", "category": "商店", "label": "学习桌价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.bookshelf", "file": "settings", "category": "商店", "label": "书架价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.sofa", "file": "settings", "category": "商店", "label": "小沙发价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.armchair", "file": "settings", "category": "商店", "label": "单人沙发价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.fridge", "file": "settings", "category": "商店", "label": "小冰箱价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.tv", "file": "settings", "category": "商店", "label": "电视机价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    # -- 星空/露营 --
    {"path": "shop.prices.star_rug", "file": "settings", "category": "商店", "label": "星空地毯价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.star_books", "file": "settings", "category": "商店", "label": "书堆价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.star_chair", "file": "settings", "category": "商店", "label": "星光椅子价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.moon_lamp", "file": "settings", "category": "商店", "label": "月亮灯价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.planet", "file": "settings", "category": "商店", "label": "星球摆件价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.star_desk", "file": "settings", "category": "商店", "label": "星云书桌价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.aurora", "file": "settings", "category": "商店", "label": "极光挂画价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.telescope", "file": "settings", "category": "商店", "label": "望远镜价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.picnic", "file": "settings", "category": "商店", "label": "野餐垫价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.camp_chair", "file": "settings", "category": "商店", "label": "露营椅价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.camp_lamp", "file": "settings", "category": "商店", "label": "露营灯价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.cooler", "file": "settings", "category": "商店", "label": "保温箱价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.campfire", "file": "settings", "category": "商店", "label": "篝火价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.tent", "file": "settings", "category": "商店", "label": "露营帐篷价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    # -- 海边 --
    {"path": "shop.prices.shell", "file": "settings", "category": "商店", "label": "贝壳价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.crab", "file": "settings", "category": "商店", "label": "小螃蟹价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.sea_rug", "file": "settings", "category": "商店", "label": "沙毯价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.sandcastle", "file": "settings", "category": "商店", "label": "沙堡价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.beach_chair", "file": "settings", "category": "商店", "label": "沙滩椅价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.beach_umbrella", "file": "settings", "category": "商店", "label": "遮阳伞价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.hammock", "file": "settings", "category": "商店", "label": "吊床价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.fish_tank", "file": "settings", "category": "商店", "label": "鱼缸价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    # -- 森林 --
    {"path": "shop.prices.mushroom", "file": "settings", "category": "商店", "label": "蘑菇价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.log", "file": "settings", "category": "商店", "label": "木桩价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.tree", "file": "settings", "category": "商店", "label": "小树价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.birdhouse", "file": "settings", "category": "商店", "label": "鸟屋价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.beehive", "file": "settings", "category": "商店", "label": "蜂箱价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.stump_table", "file": "settings", "category": "商店", "label": "树桩桌价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.forest_lamp", "file": "settings", "category": "商店", "label": "萤火灯价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    {"path": "shop.prices.swing", "file": "settings", "category": "商店", "label": "秋千价格", "type": "int", "min": 0, "max": 2000, "step": 10},
    # 打卡
